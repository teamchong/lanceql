...
__export(index_exports, {
  ChunkedLanceReader: () => ChunkedLanceReader2,
  CostModel: () => CostModel,
  ...
  SqlJsDatabase: () => Database,
  SqlJsStatement: () => Statement,
  Statement: () => Statement,
