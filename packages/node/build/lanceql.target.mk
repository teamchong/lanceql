...
$(builddir)/lanceql.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/lanceql.node: TOOLSET := $(TOOLSET)
$(builddir)/lanceql.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/lanceql.node
# Add target alias
.PHONY: lanceql
lanceql: $(builddir)/lanceql.node

# Short alias for building this executable.
.PHONY: lanceql.node
lanceql.node: $(builddir)/lanceql.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/lanceql.node
