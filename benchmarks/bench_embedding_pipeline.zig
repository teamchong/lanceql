...
//!
//! NOTE: This benchmark measures LanceQL's native embedding pipeline performance.
...
pub fn main() !void {
    ...
    std.debug.print("\n", .{});
    std.debug.print("================================================================================\n", .{});
    std.debug.print("Embedding Pipeline Benchmark\n", .{});
    std.debug.print("================================================================================\n", .{});
    ...
    std.debug.print("{s:<25} {d:>9.2} ms {d:>12.1}M vecs/s\n", .{ "L2 Normalization", lanceql_norm_s * 1000, lanceql_norm_tput });
    ...
    std.debug.print("================================================================================\n", .{});
    std.debug.print("\n", .{});
    std.debug.print("Pipeline throughput:\n", .{});
